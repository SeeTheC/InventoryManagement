...
class CpuInfo extends Model
{
	...
	protected $fillable =['processor','processor_speed','motherboard','ram_size','hdd_size','current_os','os_version','gnat_id','gnat_date','warrenty','purchase_date','ops_ref_no'];

	protected $nullable = ['ram_size','hdd_size','purchase_date'];	
