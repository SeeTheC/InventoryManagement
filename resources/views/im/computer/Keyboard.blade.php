<form method="POST" action="{{url('/computer/keyboard')}}" >
	{{csrf_field()}}
  	...
  	<div class="col-sm-12 panel-group">
   	 <div class="panel panel-primary">
		        ...
		        <h4 class="panel-title">
		          <a  href="#user">Keyboard Information</a>
		        </h4>
		      </div>
						...
						<div class="panel-body">
									...
									<div class="form-group">
								  	...
								  	<div class="form-group">
								    	...
								    	<input type="text" name="ops_ref_no" value="{{$info==null?'':$info->ops_ref_no}}"  id="ops" class="form-control" placeholder="">
								  </div>		
							</div>
